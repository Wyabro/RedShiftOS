...
The seven phases a game moves through, in order. Read `FOUNDATION/` guidance for the phase
you're in (pull it by task); the phases are a **map**, not a mandate to create empty folders.
A phase gets a folder only once it holds real content — the rest are covered by FOUNDATION for
now and grow when a game fills them (creating empty phase folders is the Architecture
Astronautics smell this OS refuses — Decision #1).
